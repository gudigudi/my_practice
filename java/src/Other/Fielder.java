...
public interface Fielder {
    ...
    /**
     * Return the fielding avarage, defined as (try - errors)/trys.
     * @return A float that is the player's fielding average
     */
    float getFieldingAverage();

    /**
     * Return teh player's fielding range, defined as
     * ((putouts + assists)/innings) * 9.
    ...
    /**
     * The number of fielding attempt by this player.
