<template>
  <div>
    <a href="javascript:;" :title="lang.title" :class="{'disabled':disabled,'active':display}" @click="toggle">
      <i class="icon-table"></i>
    </a>
    <div class="toolbar-dropdown table" v-show="display">
      <ul>
...
<script>
  export default {
    ...
    methods: {
      ...
      toggle () {
        !this.disabled && this.updatePopupDisplay('table')
      },
      overHandler (index) {
        this.x = index % 8
