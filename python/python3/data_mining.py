...
def computeNearesNeightbor(username, users):
    ...
    distances.sort()
    return distances
print(computeNearesNeightbor("Hailey", users))

def recommend(username, users):
    """Give list of recommendations"""
    # first find nearest neighbor
    nearest = computeNearesNeightbor(username, users)[0][1]
    recommendations = []
...
print(computeNearesNeightbor('Angelica', users))
